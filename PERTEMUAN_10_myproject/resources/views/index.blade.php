...
<section class="relative h-screen flex items-center justify-center" id="hero">
  ...
  <nav class="absolute top-0 left-0 w-full bg-black/30 backdrop-blur-sm text-white flex justify-between items-center px-8 py-4 z-10">
    <h1 class="text-2xl font-bold text-[#d4af37]">Kedai Pattaya</h1>
    <ul class="flex space-x-8 text-lg">
      <li><a href="#hero" class="text-[#d4af37] hover:text-[#f5d67a] transition">Beranda</a></li>
      <li><a href="#menu" class="text-[#d4af37] hover:text-[#f5d67a] transition">Menu</a></li>
      <li><button id="lokasiBtn" class="text-[#d4af37] hover:text-[#f5d67a] transition focus:outline-none">Lokasi</button></li>
    </ul>
  </nav>
      ...
      <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="grid gap-14 md:grid-cols-2 justify-center">
          <div class="card-bg rounded-3xl shadow-2xl p-8 flex flex-col items-center hover:scale-105 transition duration-300">
            ...
            <h3 class="font-bold text-3xl accent mt-6">Thai Iced Tea</h3>
  ...
  <div id="lokasiSlide" class="fixed inset-0 z-50 hidden flex-col items-center justify-center bg-[#1e1e1e]/95 backdrop-blur-sm">
